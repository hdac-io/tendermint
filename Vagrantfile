...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    echo 'cd go/src/github.com/hdac-io/tendermint' >> /home/vagrant/.bash_profile

    mkdir -p /home/vagrant/go/bin
    mkdir -p /home/vagrant/go/src/github.com/hdac-io
    ln -s /vagrant /home/vagrant/go/src/github.com/hdac-io/tendermint
    ...
    su - vagrant -c 'cd /home/vagrant/go/src/github.com/hdac-io/tendermint && make tools'
  SHELL
end
